// ==UserScript==
// @name         Comick.io Random Comic Button
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/532268/Comickio%20Random%20Comic%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/532268/Comickio%20Random%20Comic%20Button.meta.js
// ==/UserScript==
...
(function() {
    ...
    function loadPage(page, maxPages = 50) {
        GM_xmlhttpRequest({
            method: "GET",
            url: `https://api.comick.io/v1.0/search?limit=50&page=${page}`,
    ...
    function updateButton() {
        const homeLink = document.querySelector('a[href="/home2"].relative.grow-0.w-9\\/12.flex.justify-center.h-28, a[href="/home2"].relative.grow-0.flex.justify-center');
        ...
        newHomeLink.addEventListener('click', function(e) {
            ...
            if (randomComic && randomComic.slug) {
                window.location.href = `https://comick.io/comic/${randomComic.slug}`;
            }
        });
